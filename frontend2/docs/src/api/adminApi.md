# 📚 Documentation Technique Détaillée : `adminApi.js`

**Emplacement Source** : `src/api/adminApi.js`  
...
Le fichier `adminApi.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| :--- | :--- | :--- |
| L2 | `import apiClient from "./apiClient";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `adminApi` (Ligne 5)
- **Signature / Extrait** : `export const adminApi = {`
