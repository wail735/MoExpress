# 📚 Documentation Technique Détaillée : `paymentApi.js`

**Emplacement Source** : `src/api/paymentApi.js`  
...
Le fichier `paymentApi.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
#### 🔹 `paymentApi` (Ligne 5)
- **Signature / Extrait** : `export const paymentApi = {`
