# 📚 Documentation Technique Détaillée : `authApi.js`

**Emplacement Source** : `src/api/authApi.js`  
...
Le fichier `authApi.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
#### 🔹 `authApi` (Ligne 5)
- **Signature / Extrait** : `export const authApi = {`
