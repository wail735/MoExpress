# 📚 Documentation Technique Détaillée : `productApi.js`

**Emplacement Source** : `src/api/productApi.js`  
**Portée** : Frontend Client React (Vite SPA)  
**Nombre de Lignes Code** : 22 lignes  

---

## 1. 📌 Rôle et Responsabilité du Fichier

Le fichier `productApi.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| :--- | :--- | :--- |
| L1 | `import apiClient from "./apiClient";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `productApi` (Ligne 5)
- **Signature / Extrait** : `export const productApi = {`
