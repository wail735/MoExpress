# 📚 Documentation Technique Détaillée : `AdminAffiliateTiers.jsx`

**Emplacement Source** : `src/pages/admin/AdminAffiliateTiers.jsx`  
...
Le fichier `AdminAffiliateTiers.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { Share2, Save } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `AdminAffiliateTiers` (Ligne 10)
- **Signature / Extrait** : `export const AdminAffiliateTiers = () => {`
