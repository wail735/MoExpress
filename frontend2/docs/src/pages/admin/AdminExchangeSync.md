# 📚 Documentation Technique Détaillée : `AdminExchangeSync.jsx`

**Emplacement Source** : `src/pages/admin/AdminExchangeSync.jsx`  
...
Le fichier `AdminExchangeSync.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { RefreshCw, Save, TrendingUp } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `AdminExchangeSync` (Ligne 10)
- **Signature / Extrait** : `export const AdminExchangeSync = () => {`
...
#### 🔹 `handleSyncNow` (Ligne 14)
- **Signature / Extrait** : `const handleSyncNow = () => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Synchrone.
