# 📚 Documentation Technique Détaillée : `AdminCommissionMatrix.jsx`

**Emplacement Source** : `src/pages/admin/AdminCommissionMatrix.jsx`  
...
Le fichier `AdminCommissionMatrix.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { Percent, Save } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `AdminCommissionMatrix` (Ligne 10)
- **Signature / Extrait** : `export const AdminCommissionMatrix = () => {`
