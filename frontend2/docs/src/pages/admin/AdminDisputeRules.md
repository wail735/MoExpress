# 📚 Documentation Technique Détaillée : `AdminDisputeRules.jsx`

**Emplacement Source** : `src/pages/admin/AdminDisputeRules.jsx`  
...
Le fichier `AdminDisputeRules.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { ShieldCheck, Save, Sliders } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `AdminDisputeRules` (Ligne 10)
- **Signature / Extrait** : `export const AdminDisputeRules = () => {`
