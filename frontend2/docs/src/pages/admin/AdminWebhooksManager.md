# 📚 Documentation Technique Détaillée : `AdminWebhooksManager.jsx`

**Emplacement Source** : `src/pages/admin/AdminWebhooksManager.jsx`  
...
Le fichier `AdminWebhooksManager.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { Globe, Plus, Trash2 } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `AdminWebhooksManager` (Ligne 10)
- **Signature / Extrait** : `export const AdminWebhooksManager = () => {`
