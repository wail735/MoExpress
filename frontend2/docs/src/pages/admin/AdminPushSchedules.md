# 📚 Documentation Technique Détaillée : `AdminPushSchedules.jsx`

**Emplacement Source** : `src/pages/admin/AdminPushSchedules.jsx`  
...
Le fichier `AdminPushSchedules.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { Bell, Calendar, Plus } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `AdminPushSchedules` (Ligne 10)
- **Signature / Extrait** : `export const AdminPushSchedules = () => {`
