# 📚 Documentation Technique Détaillée : `AdminSupplierCertification.jsx`

**Emplacement Source** : `src/pages/admin/AdminSupplierCertification.jsx`  
...
Le fichier `AdminSupplierCertification.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { ShieldCheck, Award, Check, X } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `AdminSupplierCertification` (Ligne 10)
- **Signature / Extrait** : `export const AdminSupplierCertification = () => {`
...
#### 🔹 `handleGrantBadge` (Ligne 16)
- **Signature / Extrait** : `const handleGrantBadge = (id, status) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Synchrone.
