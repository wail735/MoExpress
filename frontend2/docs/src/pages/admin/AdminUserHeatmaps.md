# 📚 Documentation Technique Détaillée : `AdminUserHeatmaps.jsx`

**Emplacement Source** : `src/pages/admin/AdminUserHeatmaps.jsx`  
**Portée** : Frontend Client React (Vite SPA)  
**Nombre de Lignes Code** : 116 lignes  

---

## 1. 📌 Rôle et Responsabilité du Fichier

Le fichier `AdminUserHeatmaps.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { Activity, Globe, Eye, Download, Filter, MapPin } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `AdminUserHeatmaps` (Ligne 10)
- **Signature / Extrait** : `export const AdminUserHeatmaps = () => {`
...
#### 🔹 `handleExportLogs` (Ligne 24)
- **Signature / Extrait** : `const handleExportLogs = () => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Synchrone.
