# 📚 Documentation Technique Détaillée : `AdminDispatchTower.jsx`

**Emplacement Source** : `src/pages/admin/AdminDispatchTower.jsx`  
...
Le fichier `AdminDispatchTower.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { Truck, MapPin, Radio } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `AdminDispatchTower` (Ligne 9)
- **Signature / Extrait** : `export const AdminDispatchTower = () => {`
