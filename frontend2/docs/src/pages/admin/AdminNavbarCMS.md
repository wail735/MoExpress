# 📚 Documentation Technique Détaillée : `AdminNavbarCMS.jsx`

**Emplacement Source** : `src/pages/admin/AdminNavbarCMS.jsx`  
...
Le fichier `AdminNavbarCMS.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { Globe, Save, Sparkles, Layout } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `AdminNavbarCMS` (Ligne 11)
- **Signature / Extrait** : `export const AdminNavbarCMS = () => {`
