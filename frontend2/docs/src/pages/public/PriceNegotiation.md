# 📚 Documentation Technique Détaillée : `PriceNegotiation.jsx`

**Emplacement Source** : `src/pages/public/PriceNegotiation.jsx`  
...
Le fichier `PriceNegotiation.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { DollarSign, Send, MessageSquare } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `PriceNegotiation` (Ligne 11)
- **Signature / Extrait** : `export const PriceNegotiation = () => {`
...
#### 🔹 `handleSendOffer` (Ligne 16)
- **Signature / Extrait** : `const handleSendOffer = (e) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Synchrone.
