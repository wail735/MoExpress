# 📚 Documentation Technique Détaillée : `BoutiqueProfile.jsx`

**Emplacement Source** : `src/pages/public/BoutiqueProfile.jsx`  
...
Le fichier `BoutiqueProfile.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { useParams, Link } from "react-router-dom";` | Module indispensable pour les fonctionnalités du fichier. |
| L8 | `import { Award, ShieldCheck, Store, MapPin, Star, ShoppingBag, Palette, Type, Sparkles, MessageSquare, Check } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `BoutiqueProfile` (Ligne 13)
- **Signature / Extrait** : `export const BoutiqueProfile = () => {`
