# 📚 Documentation Technique Détaillée : `BrandDirectory.jsx`

**Emplacement Source** : `src/pages/public/BrandDirectory.jsx`  
**Portée** : Frontend Client React (Vite SPA)  
**Nombre de Lignes Code** : 134 lignes  

---

## 1. 📌 Rôle et Responsabilité du Fichier

Le fichier `BrandDirectory.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L8 | `import { Award, ShieldCheck, Store, Star, ArrowRight, Search, Heart, Check } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `BrandDirectory` (Ligne 11)
- **Signature / Extrait** : `export const BrandDirectory = () => {`
...
#### 🔹 `handleToggleFollow` (Ligne 29)
- **Signature / Extrait** : `const handleToggleFollow = (brandId, brandName) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Synchrone.
