# 📚 Documentation Technique Détaillée : `EcoImpact.jsx`

**Emplacement Source** : `src/pages/public/EcoImpact.jsx`  
...
Le fichier `EcoImpact.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { Leaf, Award, ShieldCheck, Check, TreePine, Recycle } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `EcoImpact` (Ligne 10)
- **Signature / Extrait** : `export const EcoImpact = () => {`
...
#### 🔹 `handlePledge` (Ligne 23)
- **Signature / Extrait** : `const handlePledge = () => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Synchrone.
