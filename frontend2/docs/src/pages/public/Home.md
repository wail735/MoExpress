# 📚 Documentation Technique Détaillée : `Home.jsx`

**Emplacement Source** : `src/pages/public/Home.jsx`  
**Portée** : Frontend Client React (Vite SPA)  
**Nombre de Lignes Code** : 362 lignes  

---

## 1. 📌 Rôle et Responsabilité du Fichier

Le fichier `Home.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L21 | `import { useCurrency } from "../../context/CurrencyContext";` | Module indispensable pour les fonctionnalités du fichier. |
| L22 | `import { useCart } from "../../context/CartContext";` | Module indispensable pour les fonctionnalités du fichier. |
| L23 | `import { useWishlist } from "../../context/WishlistContext";` | Module indispensable pour les fonctionnalités du fichier. |
| L24 | `import { useNotification } from "../../context/NotificationContext";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `Home` (Ligne 26)
- **Signature / Extrait** : `export const Home = () => {`
