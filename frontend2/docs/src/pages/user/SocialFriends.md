# 📚 Documentation Technique Détaillée : `SocialFriends.jsx`

**Emplacement Source** : `src/pages/user/SocialFriends.jsx`  
...
Le fichier `SocialFriends.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { Users, UserPlus, MessageSquare, Check, X, ShieldCheck, Award } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `SocialFriends` (Ligne 11)
- **Signature / Extrait** : `export const SocialFriends = () => {`
...
#### 🔹 `handleAddFriend` (Ligne 29)
- **Signature / Extrait** : `const handleAddFriend = (e) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Synchrone.
