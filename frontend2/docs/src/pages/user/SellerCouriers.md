# 📚 Documentation Technique Détaillée : `SellerCouriers.jsx`

**Emplacement Source** : `src/pages/user/SellerCouriers.jsx`  
...
Le fichier `SellerCouriers.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { Truck, Check, Save } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `SellerCouriers` (Ligne 10)
- **Signature / Extrait** : `export const SellerCouriers = () => {`
