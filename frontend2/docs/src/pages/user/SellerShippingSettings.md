# 📚 Documentation Technique Détaillée : `SellerShippingSettings.jsx`

**Emplacement Source** : `src/pages/user/SellerShippingSettings.jsx`  
...
Le fichier `SellerShippingSettings.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { Truck, Save, Check, Globe } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `SellerShippingSettings` (Ligne 10)
- **Signature / Extrait** : `export const SellerShippingSettings = () => {`
