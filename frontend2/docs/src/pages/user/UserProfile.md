# 📚 Documentation Technique Détaillée : `UserProfile.jsx`

**Emplacement Source** : `src/pages/user/UserProfile.jsx`  
...
Le fichier `UserProfile.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L8 | `import { User, Mail, ShieldCheck, Award, MapPin, Key, Save, Store, Package, Coins, Sparkles, Heart, CreditCard } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `UserProfile` (Ligne 12)
- **Signature / Extrait** : `export const UserProfile = () => {`
