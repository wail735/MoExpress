# 📚 Documentation Technique Détaillée : `UserAddresses.jsx`

**Emplacement Source** : `src/pages/user/UserAddresses.jsx`  
...
Le fichier `UserAddresses.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { MapPin, Plus, Trash2, Check } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `UserAddresses` (Ligne 10)
- **Signature / Extrait** : `export const UserAddresses = () => {`
...
#### 🔹 `handleAddAddress` (Ligne 20)
- **Signature / Extrait** : `const handleAddAddress = (e) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Synchrone.
