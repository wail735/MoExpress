# 📚 Documentation Technique Détaillée : `Badge.jsx`

**Emplacement Source** : `src/components/ui/Badge.jsx`  
...
Le fichier `Badge.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
#### 🔹 `Badge` (Ligne 8)
- **Signature / Extrait** : `export const Badge = ({ children, variant = "default", className = "", icon: Icon }) => {`
