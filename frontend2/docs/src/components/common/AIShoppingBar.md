# 📚 Documentation Technique Détaillée : `AIShoppingBar.jsx`

**Emplacement Source** : `src/components/common/AIShoppingBar.jsx`  
...
Le fichier `AIShoppingBar.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { Sparkles, ArrowRight, X } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `AIShoppingBar` (Ligne 10)
- **Signature / Extrait** : `export const AIShoppingBar = () => {`
