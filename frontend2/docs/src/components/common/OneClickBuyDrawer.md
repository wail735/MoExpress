# 📚 Documentation Technique Détaillée : `OneClickBuyDrawer.jsx`

**Emplacement Source** : `src/components/common/OneClickBuyDrawer.jsx`  
...
Le fichier `OneClickBuyDrawer.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { Zap, X, ShieldCheck } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `OneClickBuyDrawer` (Ligne 11)
- **Signature / Extrait** : `export const OneClickBuyDrawer = ({ product, isOpen, onClose }) => {`
