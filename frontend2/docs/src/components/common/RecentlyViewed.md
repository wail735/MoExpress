# 📚 Documentation Technique Détaillée : `RecentlyViewed.jsx`

**Emplacement Source** : `src/components/common/RecentlyViewed.jsx`  
...
Le fichier `RecentlyViewed.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L8 | `import { Eye, X } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `RecentlyViewed` (Ligne 11)
- **Signature / Extrait** : `export const RecentlyViewed = () => {`
