# 📚 Documentation Technique Détaillée : `ConfettiReward.jsx`

**Emplacement Source** : `src/components/common/ConfettiReward.jsx`  
...
Le fichier `ConfettiReward.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { Sparkles } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `ConfettiReward` (Ligne 9)
- **Signature / Extrait** : `export const ConfettiReward = ({ active }) => {`
