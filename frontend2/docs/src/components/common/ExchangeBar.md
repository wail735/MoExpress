# 📚 Documentation Technique Détaillée : `ExchangeBar.jsx`

**Emplacement Source** : `src/components/common/ExchangeBar.jsx`  
**Portée** : Frontend Client React (Vite SPA)  
**Nombre de Lignes Code** : 30 lignes  

---

## 1. 📌 Rôle et Responsabilité du Fichier

Le fichier `ExchangeBar.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { TrendingUp } from "lucide-react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `ExchangeBar` (Ligne 10)
- **Signature / Extrait** : `export const ExchangeBar = () => {`
