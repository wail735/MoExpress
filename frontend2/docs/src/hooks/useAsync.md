# 📚 Documentation Technique Détaillée : `useAsync.js`

**Emplacement Source** : `src/hooks/useAsync.js`  
...
Le fichier `useAsync.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| :--- | :--- | :--- |
| L6 | `import { useState, useCallback } from "react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `useAsync` (Ligne 8)
- **Signature / Extrait** : `export const useAsync = (asyncFunction) => {`
