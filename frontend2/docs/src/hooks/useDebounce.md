# 📚 Documentation Technique Détaillée : `useDebounce.js`

**Emplacement Source** : `src/hooks/useDebounce.js`  
...
Le fichier `useDebounce.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| :--- | :--- | :--- |
| L6 | `import { useState, useEffect } from "react";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `useDebounce` (Ligne 8)
- **Signature / Extrait** : `export const useDebounce = (value, delay = 300) => {`
