# 📚 Documentation Technique Détaillée : `useLocalStorage.js`

**Emplacement Source** : `src/hooks/useLocalStorage.js`  
...
Le fichier `useLocalStorage.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
#### 🔹 `useLocalStorage` (Ligne 8)
- **Signature / Extrait** : `export const useLocalStorage = (key, initialValue) => {`
