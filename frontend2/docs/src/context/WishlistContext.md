# 📚 Documentation Technique Détaillée : `WishlistContext.jsx`

**Emplacement Source** : `src/context/WishlistContext.jsx`  
**Portée** : Frontend Client React (Vite SPA)  
**Nombre de Lignes Code** : 60 lignes  

---

## 1. 📌 Rôle et Responsabilité du Fichier

Le fichier `WishlistContext.jsx` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
#### 🔹 `WishlistProvider` (Ligne 10)
- **Signature / Extrait** : `export const WishlistProvider = ({ children }) => {`
...
#### 🔹 `toggleWishlist` (Ligne 20)
- **Signature / Extrait** : `const toggleWishlist = (product) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Synchrone.

#### 🔹 `removeFromWishlist` (Ligne 33)
- **Signature / Extrait** : `const removeFromWishlist = (productIdOrProduct) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Synchrone.

#### 🔹 `isInWishlist` (Ligne 41)
- **Signature / Extrait** : `const isInWishlist = (productId) =>`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Synchrone.

#### 🔹 `useWishlist` (Ligne 59)
- **Signature / Extrait** : `export const useWishlist = () => useContext(WishlistContext);`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Synchrone.
