# 📚 Documentation Technique Détaillée : `user.model.js`

**Emplacement Source** : `users/user.model.js`  
...
Le fichier `user.model.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
#### 🔹 `User` (Ligne 138)
- **Signature / Extrait** : `export const User = mongoose.models.User \|\| mongoose.model("User", userSchema);`
