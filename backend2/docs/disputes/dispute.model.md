# 📚 Documentation Technique Détaillée : `dispute.model.js`

**Emplacement Source** : `disputes/dispute.model.js`  
...
Le fichier `dispute.model.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
#### 🔹 `Dispute` (Ligne 67)
- **Signature / Extrait** : `export const Dispute = mongoose.models.Dispute \|\| mongoose.model("Dispute", disputeSchema);`
