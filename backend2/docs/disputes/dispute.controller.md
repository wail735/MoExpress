# 📚 Documentation Technique Détaillée : `dispute.controller.js`

**Emplacement Source** : `disputes/dispute.controller.js`  
...
Le fichier `dispute.controller.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| :--- | :--- | :--- |
| L6 | `import * as disputeService from "./dispute.service.js";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `createDispute` (Ligne 11)
- **Signature / Extrait** : `export const createDispute = async (req, res) => {`
...
#### 🔹 `respondDispute` (Ligne 23)
- **Signature / Extrait** : `export const respondDispute = async (req, res) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Asynchrone avec retour de Promesse (`Promise`).

#### 🔹 `arbitrate` (Ligne 36)
- **Signature / Extrait** : `export const arbitrate = async (req, res) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Asynchrone avec retour de Promesse (`Promise`).

#### 🔹 `getMyDisputes` (Ligne 48)
- **Signature / Extrait** : `export const getMyDisputes = async (req, res) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Asynchrone avec retour de Promesse (`Promise`).

#### 🔹 `getAllDisputes` (Ligne 60)
- **Signature / Extrait** : `export const getAllDisputes = async (req, res) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Asynchrone avec retour de Promesse (`Promise`).
