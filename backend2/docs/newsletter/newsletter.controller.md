# 📚 Documentation Technique Détaillée : `newsletter.controller.js`

**Emplacement Source** : `newsletter/newsletter.controller.js`  
...
Le fichier `newsletter.controller.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| :--- | :--- | :--- |
| L6 | `import * as newsletterService from "./newsletter.service.js";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `unsubscribe` (Ligne 30)
- **Signature / Extrait** : `export const unsubscribe = async (req, res) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Asynchrone avec retour de Promesse (`Promise`).

#### 🔹 `getSubscribers` (Ligne 45)
- **Signature / Extrait** : `export const getSubscribers = async (req, res) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Asynchrone avec retour de Promesse (`Promise`).

#### 🔹 `sendCampaign` (Ligne 57)
- **Signature / Extrait** : `export const sendCampaign = async (req, res) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Asynchrone avec retour de Promesse (`Promise`).
