# 📚 Documentation Technique Détaillée : `social.routes.js`

**Emplacement Source** : `social/social.routes.js`  
...
Le fichier `social.routes.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import * as socialController from "./social.controller.js";` | Module indispensable pour les fonctionnalités du fichier. |
