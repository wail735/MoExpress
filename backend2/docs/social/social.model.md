# 📚 Documentation Technique Détaillée : `social.model.js`

**Emplacement Source** : `social/social.model.js`  
**Portée** : Backend Serveur (Node.js / Express)  
**Nombre de Lignes Code** : 76 lignes  

---

## 1. 📌 Rôle et Responsabilité du Fichier

Le fichier `social.model.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
#### 🔹 `FriendRequest` (Ligne 69)
- **Signature / Extrait** : `export const FriendRequest = mongoose.models.FriendRequest \|\| mongoose.model("FriendRequest", friendRequestSchema);`
...
#### 🔹 `Review` (Ligne 70)
- **Signature / Extrait** : `export const Review = mongoose.models.Review \|\| mongoose.model("Review", reviewSchema);`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Synchrone.
