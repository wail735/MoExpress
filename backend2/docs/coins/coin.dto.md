# 📚 Documentation Technique Détaillée : `coin.dto.js`

**Emplacement Source** : `coins/coin.dto.js`  
...
Le fichier `coin.dto.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
#### 🔹 `buyCoinsDTO` (Ligne 8)
- **Signature / Extrait** : `export const buyCoinsDTO = Joi.object({`
