# 📚 Documentation Technique Détaillée : `coin.model.js`

**Emplacement Source** : `coins/coin.model.js`  
...
Le fichier `coin.model.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
#### 🔹 `CoinTransaction` (Ligne 43)
- **Signature / Extrait** : `export const CoinTransaction = mongoose.model("CoinTransaction", coinTransactionSchema);`
