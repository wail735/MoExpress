# 📚 Documentation Technique Détaillée : `support.model.js`

**Emplacement Source** : `support/support.model.js`  
...
Le fichier `support.model.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
#### 🔹 `SupportTicket` (Ligne 50)
- **Signature / Extrait** : `export const SupportTicket = mongoose.model("SupportTicket", supportTicketSchema);`
