# 📚 Documentation Technique Détaillée : `support.routes.js`

**Emplacement Source** : `support/support.routes.js`  
...
Le fichier `support.routes.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import * as supportController from "./support.controller.js";` | Module indispensable pour les fonctionnalités du fichier. |
