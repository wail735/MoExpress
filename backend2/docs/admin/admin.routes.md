# 📚 Documentation Technique Détaillée : `admin.routes.js`

**Emplacement Source** : `admin/admin.routes.js`  
...
Le fichier `admin.routes.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import * as adminController from "./admin.controller.js";` | Module indispensable pour les fonctionnalités du fichier. |
