# 📚 Documentation Technique Détaillée : `payment.controller.js`

**Emplacement Source** : `payments/payment.controller.js`  
...
Le fichier `payment.controller.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| :--- | :--- | :--- |
| L6 | `import * as paymentService from "./payment.service.js";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `getBankDetails` (Ligne 11)
- **Signature / Extrait** : `export const getBankDetails = async (req, res) => {`
...
#### 🔹 `checkoutStripe` (Ligne 23)
- **Signature / Extrait** : `export const checkoutStripe = async (req, res) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Asynchrone avec retour de Promesse (`Promise`).

#### 🔹 `uploadProof` (Ligne 36)
- **Signature / Extrait** : `export const uploadProof = async (req, res) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Asynchrone avec retour de Promesse (`Promise`).

#### 🔹 `getPendingProofs` (Ligne 49)
- **Signature / Extrait** : `export const getPendingProofs = async (req, res) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Asynchrone avec retour de Promesse (`Promise`).

#### 🔹 `reviewProof` (Ligne 61)
- **Signature / Extrait** : `export const reviewProof = async (req, res) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Asynchrone avec retour de Promesse (`Promise`).
