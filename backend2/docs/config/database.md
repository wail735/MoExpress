# 📚 Documentation Technique Détaillée : `database.js`

**Emplacement Source** : `config/database.js`  
...
Le fichier `database.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L10 | `import dotenv from "dotenv";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `connectDB` (Ligne 20)
- **Signature / Extrait** : `const connectDB = async () => {`
