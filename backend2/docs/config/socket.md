# 📚 Documentation Technique Détaillée : `socket.js`

**Emplacement Source** : `config/socket.js`  
**Portée** : Backend Serveur (Node.js / Express)  
**Nombre de Lignes Code** : 118 lignes  

---

## 1. 📌 Rôle et Responsabilité du Fichier

Le fichier `socket.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| :--- | :--- | :--- |
| L7 | `import { Server } from "socket.io";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `initSocket` (Ligne 50)
- **Signature / Extrait** : `export const initSocket = (httpServer) => {`
...
#### 🔹 `getIO` (Ligne 107)
- **Signature / Extrait** : `export const getIO = () => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Synchrone.
