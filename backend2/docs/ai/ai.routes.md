# 📚 Documentation Technique Détaillée : `ai.routes.js`

**Emplacement Source** : `ai/ai.routes.js`  
**Portée** : Backend Serveur (Node.js / Express)  
**Nombre de Lignes Code** : 14 lignes  

---

## 1. 📌 Rôle et Responsabilité du Fichier

Le fichier `ai.routes.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import { handleAIChat } from "./ai.controller.js";` | Module indispensable pour les fonctionnalités du fichier. |
