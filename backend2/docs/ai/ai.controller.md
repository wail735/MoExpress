# 📚 Documentation Technique Détaillée : `ai.controller.js`

**Emplacement Source** : `ai/ai.controller.js`  
...
Le fichier `ai.controller.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| :--- | :--- | :--- |
| L6 | `import OpenAI from "openai";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `handleAIChat` (Ligne 13)
- **Signature / Extrait** : `export const handleAIChat = async (req, res) => {`
