# 📚 Documentation Technique Détaillée : `order.routes.js`

**Emplacement Source** : `orders/order.routes.js`  
...
Le fichier `order.routes.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import * as orderController from "./order.controller.js";` | Module indispensable pour les fonctionnalités du fichier. |
