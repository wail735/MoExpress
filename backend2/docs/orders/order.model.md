# 📚 Documentation Technique Détaillée : `order.model.js`

**Emplacement Source** : `orders/order.model.js`  
...
Le fichier `order.model.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
#### 🔹 `Order` (Ligne 78)
- **Signature / Extrait** : `export const Order = mongoose.model("Order", orderSchema);`
