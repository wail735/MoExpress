# 📚 Documentation Technique Détaillée : `notification.routes.js`

**Emplacement Source** : `notifications/notification.routes.js`  
...
Le fichier `notification.routes.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import * as notificationController from "./notification.controller.js";` | Module indispensable pour les fonctionnalités du fichier. |
