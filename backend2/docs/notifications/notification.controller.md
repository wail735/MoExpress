# 📚 Documentation Technique Détaillée : `notification.controller.js`

**Emplacement Source** : `notifications/notification.controller.js`  
...
Le fichier `notification.controller.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| :--- | :--- | :--- |
| L6 | `import * as notificationService from "./notification.service.js";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `getMyNotifications` (Ligne 11)
- **Signature / Extrait** : `export const getMyNotifications = async (req, res) => {`
...
#### 🔹 `markNotificationRead` (Ligne 23)
- **Signature / Extrait** : `export const markNotificationRead = async (req, res) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Asynchrone avec retour de Promesse (`Promise`).

#### 🔹 `markAllNotificationsRead` (Ligne 35)
- **Signature / Extrait** : `export const markAllNotificationsRead = async (req, res) => {`
- **Rôle Fonctionnel** : Cette fonction/méthode est responsable de l'exécution d'une étape clé du traitement.
- **Mode d'Exécution** : Asynchrone avec retour de Promesse (`Promise`).
