# 📚 Documentation Technique Détaillée : `notification.model.js`

**Emplacement Source** : `notifications/notification.model.js`  
...
Le fichier `notification.model.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
#### 🔹 `Notification` (Ligne 55)
- **Signature / Extrait** : `export const Notification = mongoose.models.Notification \|\| mongoose.model("Notification", notificationSchema);`
