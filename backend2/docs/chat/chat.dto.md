# 📚 Documentation Technique Détaillée : `chat.dto.js`

**Emplacement Source** : `chat/chat.dto.js`  
...
Le fichier `chat.dto.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
#### 🔹 `sendMessageDTO` (Ligne 8)
- **Signature / Extrait** : `export const sendMessageDTO = Joi.object({`
