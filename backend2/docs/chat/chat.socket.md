# 📚 Documentation Technique Détaillée : `chat.socket.js`

**Emplacement Source** : `chat/chat.socket.js`  
...
Le fichier `chat.socket.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| :--- | :--- | :--- |
| L6 | `import { saveMessage } from "./chat.service.js";` | Module indispensable pour les fonctionnalités du fichier. |
...
#### 🔹 `registerChatSocketHandlers` (Ligne 12)
- **Signature / Extrait** : `export const registerChatSocketHandlers = (io) => {`
