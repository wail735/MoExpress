# 📚 Documentation Technique Détaillée : `chat.routes.js`

**Emplacement Source** : `chat/chat.routes.js`  
...
Le fichier `chat.routes.js` est un composant clé de l'architecture MoExpress (AliExpress Clone).
...
| L7 | `import * as chatController from "./chat.controller.js";` | Module indispensable pour les fonctionnalités du fichier. |
